...
def main():
    ...
    try:
        ...
        for dataset in datasets:
            shutil.copy(os.path.join(dataset_csv_dir, "{}.csv".format(dataset)), output_dir)
        ...
        if use_trained_model_weights:
            if use_best_weights:
                model_weights_file = os.path.join(dataset_csv_dir, "best_{}".format(output_weights_name))
            else:
